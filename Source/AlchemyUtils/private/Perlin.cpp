/**
* Perlin.cpp has been appropriated for Unreal from Chris Little's github at https://github.com/SRombauts/SimplexNoise through the MIT licence
*
...
* @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
*/
float UPerlin::Noise2D(float x, float y) {
...
* @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
*/
float UPerlin::Fractal1D(int32 octaves, float x, float frequency, float amplitude, float lacunarity, float persistence) {
	float output = 0.f;
...
* @return Noise value in the range[-1; 1], value of 0 on all integer coordinates.
*/
float UPerlin::Fractal2D(int32 octaves, float x, float y, float frequency, float amplitude, float lacunarity, float persistence) {
	float output = 0.f;
